...
class Config {
    constructor(properties) {
        ...
        this['jhipster.clientApp.name'] = 'space1';
        ...
        this['jhipster.mail.from'] = 'space1@localhost';
        this['jhipster.swagger.default-include-pattern'] = '/api/.*';
        this['jhipster.swagger.title'] = 'space1 API';
        this['jhipster.swagger.description'] = 'space1 API documentation';
        ...
        this['eureka.instance.appname'] = 'space1';
        this['eureka.instance.instanceId'] = 'space1:${random.value}';
